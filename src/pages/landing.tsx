...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#F4F9FF] text-slate-900 font-sans selection:bg-blue-100 pb-32 relative">
      ...
      {/* Top Nav */}
      <header className="flex items-center justify-between px-6 lg:px-10 py-5 bg-white/60 backdrop-blur-md border-b border-white/40 sticky top-0 z-50">
         <div className="flex items-center gap-2">
            <span className="text-2xl font-bold text-[#005CBE] tracking-tight">LANS</span>
         </div>
         <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            <span className="text-[#005CBE] border-b-2 border-[#005CBE] pb-1 cursor-pointer">Dashboard</span>
            ...
            <span className="hover:text-slate-900 cursor-pointer">DeepBook</span>
         </nav>
      ...
      <div className="flex flex-col lg:flex-row max-w-[1440px] mx-auto px-6 lg:px-10 mt-10 gap-10 relative z-10">
        ...
        <aside className="w-full lg:w-[280px] shrink-0">
           <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-slate-100 lg:sticky lg:top-28 flex flex-col h-auto lg:min-h-[calc(100vh-160px)]">
              
              <div className="flex items-center gap-4 mb-10 pl-2">
                <div className="w-12 h-12 rounded-full bg-[#EAF2FF] flex items-center justify-center text-[#005CBE]">
                  <Bot className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="font-semibold text-slate-900 text-sm">AI Concierge</h3>
                  <p className="text-[10px] font-bold text-[#005CBE] tracking-wider uppercase mt-1">Autonomous Active</p>
                </div>
              </div>

              <nav className="flex flex-col gap-2 flex-1">
                <a href="#" className="flex items-center gap-4 px-4 py-3 rounded-xl bg-[#EAF2FF] text-[#005CBE] font-medium text-sm">
                  <BarChart2 className="w-5 h-5" />
                  Overview
                </a>
                <a href="#" className="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-slate-50 text-slate-600 hover:text-slate-900 font-medium text-sm transition-colors">
              ...
              <div className="mt-10 mb-8">
                <button className="w-full flex items-center justify-center gap-2 bg-[#005CBE] text-white py-3.5 rounded-xl font-medium hover:bg-[#004e9f] transition-all shadow-[0_4px_14px_rgba(0,92,190,0.25)]">
              ...
              <div className="mt-auto space-y-2 border-t border-slate-100 pt-6">
                <a href="#" className="flex items-center gap-4 px-4 py-2.5 text-slate-500 hover:text-slate-800 text-xs font-bold tracking-wider uppercase transition-colors">
        ...
        <main className="flex-1 space-y-20 py-2">
          ...
          <section className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl flex-1">
              ...
              >
                Your Smart <br/>
                <span className="text-[#005CBE]">AI Assistant</span> <br/>
                on Sui.
              </motion.h1>
              ...
              >
                <button className="px-8 py-4 bg-[#005CBE] text-white rounded-full font-semibold hover:bg-[#004e9f] transition-all shadow-[0_4px_20px_rgba(0,92,190,0.3)] hover:scale-105">
                  Get Started Free
                </button>
          ...
          <section>
            <div className="flex items-end justify-between mb-8">
              <div>
                <h2 className="text-4xl font-bold text-slate-900 tracking-tight mb-2">Meet Your AI Agents</h2>
                <p className="text-slate-600">Friendly bots ready to work for you 24/7</p>
              </div>
              <a href="#" className="text-[#005CBE] font-semibold hover:underline flex items-center gap-1 mb-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100 flex flex-col hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Smart <br/> Saver</h3>
                <p className="text-sm text-slate-500 leading-relaxed min-h-[60px] mb-8">
                  Automatically finds the safest places to grow your digital assets on Sui.
                </p>
                <div className="mb-8">
                  <div className="flex justify-between items-end mb-3">
                    <span className="text-[10px] font-bold text-slate-400 tracking-widest uppercase w-1/2">Budget<br/>Utilization</span>
                    <span className="text-sm font-bold text-slate-900 text-right w-1/2">$12,450 /<br/>$15k</span>
                  </div>
                  <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
                    <div className="bg-[#005CBE] w-[83%] h-full rounded-full" />
                  </div>
                </div>
                <div className="mt-auto flex items-center gap-3">
                  <button className="flex-1 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 rounded-xl transition-colors">
                    Pause
                  </button>
              ...
              <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100 flex flex-col hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Auto <br/> Trader</h3>
                <p className="text-sm text-slate-500 leading-relaxed min-h-[60px] mb-8">
                  DCA and swap your tokens automatically when the market hits your target prices.
                </p>
                <div className="mb-8">
                  <div className="flex justify-between items-end mb-3">
                    <span className="text-[10px] font-bold text-slate-400 tracking-widest uppercase w-1/2">Budget<br/>Utilization</span>
                    <span className="text-sm font-bold text-slate-900 text-right w-1/2">$4,120 /<br/>$25k</span>
                  </div>
                  <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
                    <div className="bg-[#005CBE] w-[16%] h-full rounded-full" />
                  </div>
                </div>
                <div className="mt-auto flex items-center gap-3">
                  <button className="flex-1 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 rounded-xl transition-colors">
              ...
              <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100 flex flex-col hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1 bg-slate-100 text-slate-600 rounded-full text-[10px] font-bold uppercase tracking-wider">
                    <div className="w-1.5 h-1.5 rounded-full bg-slate-400" />
                    Paused
                  </div>
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-3">Safety <br/> Shield</h3>
                <p className="text-sm text-slate-500 leading-relaxed min-h-[60px] mb-8">
                  A watchful AI guardian that moves your money to stablecoins if markets get too bumpy.
                </p>
                <div className="mb-8">
                  <div className="flex justify-between items-end mb-3">
                    <span className="text-[10px] font-bold text-slate-400 tracking-widest uppercase w-1/2">Budget<br/>Utilization</span>
                    <span className="text-sm font-bold text-slate-900 text-right w-1/2">$0 /<br/>$50k</span>
                  </div>
                  <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
                ...
                <div className="mt-auto flex items-center gap-3">
                  <button className="flex-1 py-3 text-sm font-semibold text-white bg-[#005CBE] hover:bg-[#004e9f] rounded-xl transition-colors">
                    Resume
                  </button>
                  <button className="flex-1 py-3 text-sm font-semibold text-[#005CBE] bg-[#EAF2FF] hover:bg-blue-100 rounded-xl transition-colors">
                    Configure
